    ...
    <main className="bg-black/70">
      ...
      <div className="h-[calc(100svh-70px)]">
        <div className="relative h-full p-8 pb-20 text-white">
          ...
          <Image src="https://ubixbfsaksemukbx.public.blob.vercel-storage.com/images/sfondi/spaccanapoli-1068x712.jpg" preload alt="Napoli" width={1068} height={712} className="absolute inset-0 w-full h-full object-cover" />
