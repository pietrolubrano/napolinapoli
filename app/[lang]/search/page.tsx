    ...
    return (
        <main className="bg-black/70">
          ...
          <div className="container mx-auto flex flex-col items-center p-8 min-h-[calc(100svh-70px)] relative">
            <Image src="https://ubixbfsaksemukbx.public.blob.vercel-storage.com/images/sfondi/spaccanapoli-1068x712.jpg" alt="Napoli" width={1068} height={712} className="absolute inset-0 h-full w-full object-cover" />
