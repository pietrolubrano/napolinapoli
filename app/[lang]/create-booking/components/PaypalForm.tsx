            ...
            purchase_units: [
                {
                    ...
                    description: lang === "it" ? `Acconto per prenotazione della stanza ${rooms[apartmentId].name} dal ${new Date(arrivalDate).toLocaleDateString()} al ${new Date(departureDate).toLocaleDateString()} per ${guests} ospiti` : `Deposit for booking the room ${rooms[apartmentId].name} from ${new Date(arrivalDate).toLocaleDateString()} to ${new Date(departureDate).toLocaleDateString()} for ${guests} guests`,
                },
            ]
        });
    };
